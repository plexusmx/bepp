...
public class DetalleCompraNoFacturaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_compra_no_factura);
        ...
        numTrajeta.setTransformationMethod(new DetalleCompraActivity.MyPasswordTransformationMethod());
        ...
        siguenteCotizarFinalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                submitForm();
                Intent compraExitoIntent = new Intent(DetalleCompraNoFacturaActivity.this, CompraExitosaActivity.class);
        ...
        USER_CLIENT_RETROFIT_PACIENT.infoFarmaciaReceta(id_receta).enqueue(new Callback<List<PackageSend>>() {
            ...
            public void onResponse(Call<List<PackageSend>> call, Response<List<PackageSend>> response) {
                ...
                if(response.code() == 200){
                    ...
                    Toast.makeText( DetalleCompraNoFacturaActivity.this, "Error en el servidor", Toast.LENGTH_LONG).show();

                }else if(response.code() == 403){


                    Toast.makeText( DetalleCompraNoFacturaActivity.this, "La sesión ha expirado", Toast.LENGTH_LONG).show();
...
//            sendPost(card);
            ...
            Toast.makeText(DetalleCompraNoFacturaActivity.this, "error: " + e.getMessage(), Toast.LENGTH_LONG).show();
            e.printStackTrace();
...
*/
    ...
    public static class MyPasswordTransformationMethod extends PasswordTransformationMethod {
        ...
        public CharSequence getTransformation(CharSequence source, View view) {
            return new DetalleCompraNoFacturaActivity.MyPasswordTransformationMethod.PasswordCharSequence(source);
        }
