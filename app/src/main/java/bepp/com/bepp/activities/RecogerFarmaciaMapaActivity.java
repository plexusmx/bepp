...
public class RecogerFarmaciaMapaActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recoger_farmacia_mapa);
        ...
        btnDireccion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent nvaDireccionIntent = new Intent(RecogerFarmaciaMapaActivity.this, MedicinasRecetasActivity.class);
