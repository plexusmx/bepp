...
public class Card {
    ...
    public Card deviceIdString(final String deviceIdString) {
    ...
    public String toString() {
        return String
                .format("Card [creationDate=%s, id=%s, bankName=%s, allowsPayouts=%s, holderName=%s, expirationMonth=%s, expirationYear=%s, address=%s, cardNumber=%s, brand=%s, allowsCharges=%s, bankCode=%s, type=%s, cvv2=%s, deviceIdString=%s]",
                        ...
                        this.allowsCharges, this.bankCode, this.type, this.cvv2, this.deviceIdString );
    }
